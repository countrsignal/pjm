...
class NoamOpt:
    ...
    def __init__(self, model_size, factor, warmup, optimizer):
        # Mutable data - changes in NoamOpt param_groups WILL change those of base optimizer!
...
def get_std_opt(parameters, d_model, factor, warmup, weight_decay):
    # DAFAULT factor=2.0, warmup=4000
    return NoamOpt(
        d_model,
        factor,
        warmup,
        torch.optim.Adam(parameters, lr=0.0, betas=(0.9, 0.98), eps=1e-9, weight_decay=weight_decay)
    )
